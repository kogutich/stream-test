...
// Youtube не отдает больше 50 видео за запрос
 ...
 * @param {String} duration Продолжительность видео
 * @returns {Promise<*>}
 */
const searchVideos = ({searchQuery, youtubeKey, maxResultsCount, pageToken, duration = 'short'}) => {
